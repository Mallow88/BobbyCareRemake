            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h1 class="page-title mb-2">ผู้จัดการอาวุโส</h1>
                            <p class="text-muted mb-0 fs-5">พิจารณาและอนุมัติขั้นสุดท้ายของคำขอบริการ</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <div class="d-flex gap-2 justify-content-lg-end justify-content-start flex-wrap">
                        <a href="senior_list.php" class="btn btn-gradient">
                            <i class="fas fa-history me-2"></i>รายการที่พิจารณาแล้ว
                        </a>
