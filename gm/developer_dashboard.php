...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">
                ...
                <span class="page-title">Developer Dashboard</span>
            </a>
    ...
    <div class="container mt-5 pt-5">
        <!-- Header -->
        <div class="glass-card p mb-2">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h1 class="page-title mb-2">
                        <i class="fas fa-users-cog me-3"></i>Developer Dashboard
                    </h1>
                    <p class="text-muted mb-0 fs-5">ติดตามสถานะและงานของ Developer แต่ละคนแบบละเอียด</p>
                </div>
        ...
        <div class="glass-card p mb-2">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <label class="form-label fw-bold">สถิติรวม:</label>
                    <div class="stats-grid">
                        ...
                        <div class="stat-item">
                            <div class="stat-number text-warning"><?= count(array_filter($tasks, fn($t) => in_array($t['task_status'], ['pending', 'received']))) ?></div>
                            <div class="stat-label">รอดำเนินการ</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number text-info"><?= count(array_filter($tasks, fn($t) => in_array($t['task_status'], ['in_progress', 'on_hold']))) ?></div>
                            <div class="stat-label">กำลังทำ</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number text-success"><?= count(array_filter($tasks, fn($t) => in_array($t['task_status'], ['completed', 'accepted']))) ?></div>
                            <div class="stat-label">เสร็จแล้ว</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number text-danger"><?= count(array_filter($tasks, fn($t) => $t['deadline_status'] === 'overdue')) ?></div>
