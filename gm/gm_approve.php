...
function sendLinePushFlex($toUserId, $sr)
{
            ...
            "contents" => [
                [
                    ...
                    "action" => [
                        "type" => "uri",
                        "label" => "🔎 ดูรายละเอียด",
                             "uri" => "https://care.bobbyns.com/seniorgm/seniorindex2.php?id=" . $sr['request_id']
                    ]
                ]
            ],
            "backgroundColor" => "#5677fc"
    ...
    $flexMessage = [
        "type" => "flex",
        "altText" => "📑 มีคำขอเอกสารใหม่ - จาก BobbyCare",
        "contents" => $bubble
    ];
...
$stmt = $conn->prepare("
    SELECT 
        ...
        dma.reviewed_at as reviewed_at,    
            ...
            <div class="glass-card p-4">
                ...
                <div class="approval-step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="step-details">
                           <strong>โดย:</strong> <?= htmlspecialchars($data['div_mgr_name'] . ' ' . $data['div_mgr_lastname']) ?>
                            <?php if ($data['div_mgr_reason']): ?>
                                <br><strong>หมายเหตุ:</strong> <?= htmlspecialchars($data['div_mgr_reason']) ?>
                            <?php endif; ?>
                            <br><strong>วันที่อนุมัติ:</strong> <?= date('d/m/Y H:i', strtotime($data['reviewed_at'])) ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="approval-step">
                    ...
                    <div class="step-content">
                        ...
                        <div class="step-details">
                      <strong>โดย:</strong> <?= htmlspecialchars($data['assignor_name'] . ' ' . $data['assignor_lastname']) ?>
                            ...
                            <?php endif; ?>
                            <br><strong>วันที่อนุมัติ:</strong> <?= date('d/m/Y H:i', strtotime($data['assignor_reviewed_at'])) ?>
                        </div>
                    </div>
                </div>
